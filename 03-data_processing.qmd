...
### Check outcome
Ensure that there are dependent variable (outcome). Binary or ordinal outcomes should be named as "label". Survival outcomes should be named as "label_time" and "label_status". (Can use the codes below to do it).

- For binary and ordinal outcomes: Change the name of outcome to "label" (make
sure no variables using the same name).
- For survival outcomes: Change the name of outcome to "label_time" and
"label_status" 
